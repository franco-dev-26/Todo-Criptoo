document.addEventListener('DOMContentLoaded', () => {
  ...
  if(convBtn) convBtn.addEventListener('click',()=> conv.classList.toggle('open'))
  toolsClose.addEventListener('click',()=> tools.classList.remove('open'))
  if(convClose) convClose.addEventListener('click',()=> conv.classList.remove('open'))
  tools.addEventListener('click',e=>{ if(e.target===tools) tools.classList.remove('open') })
  conv.addEventListener('click',e=>{ if(e.target===conv) conv.classList.remove('open') })
